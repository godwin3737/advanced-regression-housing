...
This assignment requires building model using Linear, Ridge and Lasso Regression to predict the selling price of house. 
...
data_description.txt have the following fields:
